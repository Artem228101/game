...
public class MyGdxGame implements Screen {
	...
	public MyGdxGame(final Drop gam) {
		...
		dropImage = new Texture(Gdx.files.internal("ponchik.png"));
		bucketImage = new Texture(Gdx.files.internal("gomer.png"));

		// загрузка звукового эффекта падающей капли и фоновой "музыки" дождя
		dropSound = Gdx.audio.newSound(Gdx.files.internal("pon.mp3"));
		rainMusic = Gdx.audio.newMusic(Gdx.files.internal("sound.mp3"));
